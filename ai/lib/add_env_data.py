...
def add_columns(data):
    for raster_file in [
        ...
        "../raw_dataset/SummerPre1750Landsat75_300_900m-003/SummerPre1750Landsat75_300_900m",
        "../raw_dataset/ecoregion1750/ecoregion1750",
        "../raw_dataset/ecoregion2014/ecoregion2014",
        "../raw_dataset/hydro500xwi-004/hydro500xwi",
        ...
        if os.path.exists(raster_file):
            print("Processing: {}".format(raster_file), flush=True)
    ...
    for vector_file in [
        ...
        if os.path.exists(vector_file):
            print("Processing: {}".format(vector_file), flush=True)
